var REFS = [
  { id: "ishii1987a-16",      text: "Ishii, Akira. 1987a. <em>Furusato Yokosuka, J\u014d</em> (Hometown Yokosuka, Vol. 1). Yokohama: Kanagawa Shimbun-sha. p. 16." },
  { id: "ishii1987a-192",     text: "Ishii, Akira. 1987a. <em>Furusato Yokosuka, J\u014d</em> (Hometown Yokosuka, Vol. 1). Yokohama: Kanagawa Shimbun-sha. p. 192." },
  { id: "ishii1987a-235",     text: "Ishii, Akira. 1987a. <em>Furusato Yokosuka, J\u014d</em> (Hometown Yokosuka, Vol. 1). Yokohama: Kanagawa Shimbun-sha. p. 235." },
  { id: "ishii1987a-248-249", text: "Ishii, Akira. 1987a. <em>Furusato Yokosuka, J\u014d</em> (Hometown Yokosuka, Vol. 1). Yokohama: Kanagawa Shimbun-sha. pp. 248\u20139." },
  { id: "ishii1987b",         text: "Ishii, Akira. 1987b. <em>Furusato Yokosuka, Ge</em> (Hometown Yokosuka, Vol. 2). Yokohama: Kanagawa Shimbun-sha." },
  { id: "cityyokosuka1981-8",     text: "Yokosuka City, Mayor\u2019s Office, Public Relations Division. 1981. <em>Kor\u014d ga Kataru Furusato no Rekishi, Hokubu-hen</em> (Hometown History as Told by an Elder, Northern Region ed.). Yokosuka: Yokosuka City. p. 8." },
  { id: "cityyokosuka1981-34-37", text: "Yokosuka City, Mayor\u2019s Office, Public Relations Division. 1981. <em>Kor\u014d ga Kataru Furusato no Rekishi, Hokubu-hen</em> (Hometown History as Told by an Elder, Northern Region ed.). Yokosuka: Yokosuka City. pp. 34\u20137." },
  ...
  { id: "hemischool1981-53", text: "Hemi School District Community Center. 1981. <em>Hemi-chiku Kor\u014d no Hanashi</em> (Hemi District Elders\u2019 Story). Yokosuka: Hemi School District Community Center. p. 53." },
  ...
  { id: "yokosukawater2015-12", text: "Yokosuka Water and Environment Study Group. 2015. <em>Yokosuka no Wakimizu</em> (Spring Water in Yokosuka). Yokosuka: Yokosuka Water and Environment Study Group. p. 12." },
  { id: "yokosukawater2015-14", text: "Yokosuka Water and Environment Study Group. 2015. <em>Yokosuka no Wakimizu</em> (Spring Water in Yokosuka). Yokosuka: Yokosuka Water and Environment Study Group. p. 14." },
...
description: `<p style="margin-bottom: 1.5em;">The yato valleys of Yokosuka hold more than their terrain suggests. Tucked between hills, these residential alcoves carry layers of history and memory held together by the satoyama ecological systems — a mosaic of secondary forests, farmlands, irrigation ponds, and grasslands interwoven with human settlement and, at its coastal edges, the marine ecosystems of satoumi — that give those layers their socio-spatial form and keep them mutually entangled. Each bamen collected here marks a site where different epochs have inscribed themselves onto the same land, their inscriptions remaining mutually load-bearing within a shared satoyama-satoumi mosaic. To read a bamen is to hold multiple temporal registers at once — and to recognize that yato's biodiversity is sustained not only by how the land is used, but by the accumulated history of how people and land have shaped each other.</p>
        ...
        },
        {
            ...
            markerColor: '#C05A40', 
            description: `In 1895, the then-mayor declared that planting trees and education were both pillars of nation-building, and gifted seeds of camphor trees to several elementary schools across the prefecture — Hemi Elementary among them <span class="ref-tooltip" data-ref-id="ishii1987a-192">(Ishii 1987a, 192)</span>. Those seeds have since grown, over some 130 years, into four large camphor trees that still stand on the school grounds. Today, children recognize camphor trees from the anime My Neighbor Totoro (1988), where Totoro lives inside one. For elders who remember the war, the trees symbolize resilience — they kept growing even as bombs fell on the surrounding hills, where machine guns and anti-aircraft batteries had been installed (<span class="ref-tooltip" data-ref-id="ishii1987a-192">Ishii 1987a, 192</span>; Hemi School District Community Center, 1981, 53). The highest mountain on the Miura Peninsula, directly south of Hemi Elementary, is called Ōkusu ("Large Camphor") Mountain — a name taken from a legendary large camphor tree said to have stood at the peak.`,
            location: {
        ...
        },
        {
            ...
            description: `<p style="margin-bottom: 1.5em;">Like other shoreline communities, Funakoshi was once a reclaimed rice paddy, its origins traced back to 1622. It bore a different name then, counted as part of the Taura district. By 1908, a community had begun to take shape — families building homes, a neighborhood doctor opening a practice. Where the entrance to the Takatoriyama Hiking Trail now stands, leading west toward the Jinmuji Temple Conservation Area, rice paddies once stretched across the low ground, while the nearby woodlands yielded mulberry, raspberry, persimmon, and chestnut.</p>
                          <p style="margin-bottom: 1.5em;">A movie theater was established in front of the Funakoshi Elementary School in the early 1900s - the first experience of modern entertainment for many. The theater itself moved several times from here, up the hills over to the east, then towards the south on Naka-dōri shopping street, where it took the name Funakoshi-kan. Unfortunately, Funakoshi-kan was burned down by a fire that erupted in 1920 and again, after having been rebuilt, in the Great Kanto Earthquake of 1923 <span class="ref-tooltip" data-ref-id="ishii1987a-128">(Ishii 1987a, 128)</span>.</p>
                          <p style="margin-bottom: 1.5em;">A man born in 1919 recalls his first cinema experience at the Funakoshi-kan - which he called "denki jyōsetsu-kan (electricity permanent housing)," a term no longer used in Japanese. What he saw was a silent movie which, in Japan, had a person known as "benshi" speak the words in place of the actors - a similar role named "takemoto" already existed for the Japanese kabuki theater. The silent movie opened with a group of musicians playing in front of the screen and continued to play in the background after the movie started. There was an intermission during which a Japanese comedy skit "manzai" was staged, and afterwards he fell asleep from the warm air inside the theater. He recalls how the air outside the theater seemed cool and fresh after spending time in the enclosed theater (Yokosuka City 1981, 156-8).</p>`,
            location: {
            ...
            description: `<p style="margin-bottom: 1.5em;">People have lived on the Miura Peninsula for some 30,000 years. Yokosuka Station and the rail line connecting it to the Tōkaidō Line opened to the public in 1889, and the city soon became a prized site for archaeological excavation, yielding numerous Jōmon-period artifacts in the decades that followed. Hirasaka Shell Mound is one such site, where Jōmon pottery and a human skeleton from the same era were unearthed.</p>
                          ...
                          <p style="margin-bottom: 1.5em;">The artifacts themselves went undiscovered until 1949, when an elementary school child stumbled upon them by chance. Further investigation determined that the piece — an undecorated clay vessel with a pointed base — belonged to the Early Jōmon period, postdating the Natsushima-style pottery, which shares the same pointed base but bears a rope-patterned design <span class="ref-tooltip" data-ref-id="ishii1987a-253">(Ishii 1987a, 253)</span>.</p>`,
            location: {
            ...
            description: `<p style="margin-bottom: 1.5em;">On the tidal flats where the Hirasaku River meets the Uraga Channel, land reclamation found one of its earliest champions in Sunamura Shinzaemon Masatsugu, a civil engineer whose entrepreneurial instincts matched his technical skill. A rising population, advances in construction methods, and the Shogunate's chronic financial strain — which pushed authorities to encourage private investment in coastal reclamation for rice production — created the conditions for his career. He had already lent his expertise to the Noge Shinden in Yokohama, later renamed the Yoshida Shinden, when he turned his attention to the marshy inlet at Kurihama.</p>
                          <p style="margin-bottom: 1.5em;">Beginning in 1660, Shinzaemon spent eight arduous years completing what would become the largest reclamation project in present-day Yokosuka: the Uchikawa Shinden. The water gate built to keep seawater from reclaiming the new paddies proved the hardest part of the work, breaking more than once before its completion in 1667 <span class="ref-tooltip" data-ref-id="ishii1987a-241">(Ishii 1987a, 241)</span>. The gate stood on a small island raised in the middle of the tidal channel, with a bridge reaching out to each bank — and it is this pairing, not any wedding, that gave the crossing its enduring name: Meoto-bashi, the "Spouse Bridge." (<a href="#confluence" onclick="openStoryPanel('confluence'); return false;">A different Meoto-bashi spans the Takatori River to the north</a>; the two are unrelated.)</p>
