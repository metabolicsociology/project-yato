...
var config = {
    ...
    chapters: [
            ...
            markerColor: '#C05A40', 
              pins: [[139.61266, 35.30648], [139.56751, 35.31709], [139.6023, 35.30615], [139.619, 35.22745]],
            description: `<p style="margin-bottom: 1.5em;">The land on which the yato stands was formed during the Miura Formation, spanning the late Miocene to early Pliocene, approximately 5 to 15 million years ago (Eto, Yazaki, Urabe & Tobe, 1998). While the yato areas are mostly mudstone and sandstone, scientists have found tuffs deposited by ash fall from volcanic activity around the fault lines and around the Sagami coast. With today's technology, scientists can now date these tephra beds more precisely, yielding a more nuanced understanding of a stratigraphy once considered a black box  <span class="ref-tooltip" data-ref-id="nozaki-utsunomiya2022">(Nozaki and Utsunomiya 2022)</span>. Researchers argue that the tuffs quarried at Kamakura, Ikego, and Takatori — whose ruins remain today — were deposited in different eras  <span class="ref-tooltip" data-ref-id="yokohamacollab2024">(Yokohama Collaborative Research Group 2024)</span>.</p>
                          <p style="margin-bottom: 1.5em;">These same tuffs preserve cold-seep assemblages — fossilized traces of chemosynthetic microbial communities that once thrived where methane and hydrogen sulfide seeped from the ancient seafloor — entombed in the volcanic ash tens of millions of years before any mason ever touched it. Nevertheless, the stones were in high demand throughout the medieval and early modern periods, a fact attested to by four surviving quarry ruins: the three at Kamakura, Ikego, and Takatori, plus a fourth further south on the peninsula at Sajima. Stonemasons valued the tuff for its softness and malleability, and while it served many purposes, among the greatest demands were landscaping for temple gardens meant to evoke nirvana, and the carving of gravestones (Umeda 2017; Yokosuka Board of Education 1985, 74). Long before a mason's chisel ever touched it, the stone already held the dead within it — and centuries later, it was cut into gravestones to hold them again. Ashes to ashes, twice over, tens of millions of years apart.</p>`,
            location: {
